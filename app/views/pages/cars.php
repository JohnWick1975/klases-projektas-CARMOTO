...
<div class="select-form position-fixed card card-body bg-light">
	<form class="d-flex flex-column" method="post">
		<div class="custom-control custom-switch">
			<input type="checkbox" class="custom-control-input" value="petrol"  name="fuel_type[]" id="customSwitch1">
			<label class="custom-control-label" for="customSwitch1">Petrol</label>
		</div>
		<div class="custom-control custom-switch">
			<input type="checkbox" class="custom-control-input" value="diesel" name="fuel_type[]" id="customSwitch2">
